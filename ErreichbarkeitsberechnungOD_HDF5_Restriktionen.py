...
#--Aufbau der Schleife--#
###########################################################################
Network = "C:\Geodaten\Material.gdb\Wegenetz\Wegenetz"
ODLayer = "ODLayer"
Radius = 3500
Radius_AP = 7500
Routen = "ODLayer\Lines"
Szenario = ["N","Variante"]
arcpy.MakeFeatureLayer_management("C:\Geodaten\Material.gdb\Wegenetz\Radschnellwege", "Variante")
arcpy.MakeFeatureLayer_management("C:\Geodaten\Material.gdb\Raster\MRH_EW_ha", "Raster")
arcpy.MakeFeatureLayer_management("C:\Geodaten\Default.gdb\MRH_AP_Strab_2011_Merge", "APs","AP>0")
...
##        arcpy.AddMessage("--Speichern--")
##        arcpy.management.SaveToLayerFile("ODLayer","C:\Geodaten\ODE"+Name,"RELATIVE")
